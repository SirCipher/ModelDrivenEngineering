 ...
 * @generated
 */
public class TrackitInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new TrackitNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				IssueTrackerEditPart.MODEL_ID));
		TrackitDiagramEditorUtil.runWizard(getShell(), wizard,
