...
import trackit.diagram.edit.policies.TrackitTextSelectionEditPolicy;
 ...
 * @generated
 */
public class IssueBlockingExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TrackitVisualIDRegistry
						.getType(trackit.diagram.edit.parts.IssueBlockingExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public IssueBlockingExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new TrackitTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrackitParserProvider.getParser(
					TrackitElementTypes.IssueBlocking_4005, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					TrackitEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new IssueBlockingExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IssueBlockingExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IssueBlockingExternalLabelFigure() {
			this.setText("Blocking");
		}
