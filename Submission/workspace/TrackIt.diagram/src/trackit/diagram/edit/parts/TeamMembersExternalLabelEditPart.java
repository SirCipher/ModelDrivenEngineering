 ...
 * @generated
 */
public class TeamMembersExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TrackitVisualIDRegistry
						.getType(trackit.diagram.edit.parts.TeamMembersExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TeamMembersExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrackitParserProvider.getParser(
					TrackitElementTypes.TeamMembers_4002, getParserElement(),
	...
	protected IFigure createFigurePrim() {
		return new TeamMembersExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TeamMembersExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TeamMembersExternalLabelFigure() {
