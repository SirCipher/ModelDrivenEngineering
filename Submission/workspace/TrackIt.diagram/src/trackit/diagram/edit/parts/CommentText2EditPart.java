 ...
 * @generated
 */
public class CommentText2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CommentText2EditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return TrackitElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrackitParserProvider
					.getParser(
							TrackitElementTypes.Comment_3003,
							getParserElement(),
							TrackitVisualIDRegistry
									.getType(trackit.diagram.edit.parts.CommentText2EditPart.VISUAL_ID));
		}
		return parser;
	}
