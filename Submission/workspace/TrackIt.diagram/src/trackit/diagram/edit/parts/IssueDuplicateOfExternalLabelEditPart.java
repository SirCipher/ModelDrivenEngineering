 ...
 * @generated
 */
public class IssueDuplicateOfExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				TrackitVisualIDRegistry
						.getType(trackit.diagram.edit.parts.IssueDuplicateOfExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public IssueDuplicateOfExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new IssueDuplicateOfExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IssueDuplicateOfExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IssueDuplicateOfExternalLabelFigure() {
			this.setText("Duplicate of");
		}
