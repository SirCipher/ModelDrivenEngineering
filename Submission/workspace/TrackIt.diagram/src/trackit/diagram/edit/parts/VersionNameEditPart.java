 ...
 * @generated
 */
public class VersionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VersionNameEditPart(View view) {
		super(view);
	}
			...
			parser = TrackitParserProvider
					.getParser(
							...
							TrackitVisualIDRegistry
									.getType(trackit.diagram.edit.parts.VersionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
