 ...
 * @generated
 */
public class MemberIssuesAssignedExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				TrackitVisualIDRegistry
						.getType(trackit.diagram.edit.parts.MemberIssuesAssignedExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public MemberIssuesAssignedExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new MemberIssuesAssignedExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MemberIssuesAssignedExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MemberIssuesAssignedExternalLabelFigure() {
			this.setText("Issues assigned");
		}
