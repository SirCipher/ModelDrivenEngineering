 ...
 * @generated
 */
public class CommentTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CommentTextEditPart(View view) {
		super(view);
	}
			...
			parser = TrackitParserProvider
					.getParser(
							...
							TrackitVisualIDRegistry
									.getType(trackit.diagram.edit.parts.CommentTextEditPart.VISUAL_ID));
		}
		return parser;
	}
