 ...
 * @generated
 */
public class TeamTeamNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TeamTeamNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TrackitParserProvider
					.getParser(
							TrackitElementTypes.Team_2001,
							getParserElement(),
							TrackitVisualIDRegistry
									.getType(trackit.diagram.edit.parts.TeamTeamNameEditPart.VISUAL_ID));
		}
		return parser;
	}
