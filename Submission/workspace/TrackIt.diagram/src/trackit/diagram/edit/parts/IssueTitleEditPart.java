 ...
 * @generated
 */
public class IssueTitleEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IssueTitleEditPart(View view) {
		super(view);
	}
			...
			parser = TrackitParserProvider
					.getParser(
							...
							TrackitVisualIDRegistry
									.getType(trackit.diagram.edit.parts.IssueTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
