 ...
 * @generated
 */
public class VersionItemSemanticEditPolicy extends
		TrackitBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public VersionItemSemanticEditPolicy() {
		super(TrackitElementTypes.Version_3001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (TrackitVisualIDRegistry.getVisualID(incomingLink) == IssueVersionsAffectedEditPart.VISUAL_ID) {
