 ...
 * @generated
 */
public class TrackitValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = TrackitDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof TrackitDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& IssueTrackerEditPart.MODEL_ID.equals(TrackitVisualIDRegistry
						.getModelID(view));
	}
