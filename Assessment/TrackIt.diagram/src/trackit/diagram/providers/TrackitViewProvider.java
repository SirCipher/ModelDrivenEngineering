 ...
 * @generated
 */
public class TrackitViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return IssueTrackerEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TrackitVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = TrackitVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!TrackitElementTypes.isKnownElementType(elementType)
				...
				if (!IssueTrackerEditPart.MODEL_ID
						.equals(TrackitVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return TeamEditPart.VISUAL_ID == visualID
				...
				|| IssueEditPart.VISUAL_ID == visualID
				|| MemberEditPart.VISUAL_ID == visualID
				|| VersionEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = TrackitVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != TrackitVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(IssueTrackerEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = TrackitVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = TrackitVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TeamEditPart.VISUAL_ID:
			return createTeam_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProductEditPart.VISUAL_ID:
			return createProduct_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case IssueEditPart.VISUAL_ID:
			return createIssue_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case MemberEditPart.VISUAL_ID:
			return createMember_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case VersionEditPart.VISUAL_ID:
			return createVersion_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case CommentEditPart.VISUAL_ID:
			return createComment_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case Comment2EditPart.VISUAL_ID:
			return createComment_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (TrackitVisualIDRegistry.getVisualID(elementTypeHint)) {
		case MemberIssuesAssignedEditPart.VISUAL_ID:
			return createMemberIssuesAssigned_4001(containerView, index,
					persisted, preferencesHint);
		case TeamMembersEditPart.VISUAL_ID:
			return createTeamMembers_4002(containerView, index, persisted,
					preferencesHint);
		case IssueDuplicateOfEditPart.VISUAL_ID:
			return createIssueDuplicateOf_4003(containerView, index, persisted,
					preferencesHint);
		case IssueDependenciesEditPart.VISUAL_ID:
			return createIssueDependencies_4004(containerView, index,
					persisted, preferencesHint);
		case IssueVersionsAffectedEditPart.VISUAL_ID:
			return createIssueVersionsAffected_4007(containerView, index,
					persisted, preferencesHint);
		case IssueBlockingEditPart.VISUAL_ID:
			return createIssueBlocking_4005(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createTeam_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TrackitVisualIDRegistry.getType(TeamEditPart.VISUAL_ID));
		...
		Node label5001 = createLabel(node,
				TrackitVisualIDRegistry.getType(TeamTeamNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createProduct_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TrackitVisualIDRegistry.getType(ProductEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createIssue_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TrackitVisualIDRegistry.getType(IssueEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createMember_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TrackitVisualIDRegistry.getType(MemberEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createVersion_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TrackitVisualIDRegistry.getType(VersionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createComment_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TrackitVisualIDRegistry.getType(CommentEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createComment_3003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TrackitVisualIDRegistry
		...
		Node label5004 = createLabel(node,
				TrackitVisualIDRegistry.getType(CommentText2EditPart.VISUAL_ID));
		createCompartment(
				node,
				TrackitVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createMemberIssuesAssigned_4001(View containerView, int index,
		...
		edge.setType(TrackitVisualIDRegistry
		...
		Node label6001 = createLabel(
				edge,
				TrackitVisualIDRegistry
						.getType(MemberIssuesAssignedExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createTeamMembers_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		...
		Node label6002 = createLabel(edge,
				TrackitVisualIDRegistry
						.getType(TeamMembersExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createIssueDuplicateOf_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6003 = createLabel(
				edge,
				TrackitVisualIDRegistry
						.getType(IssueDuplicateOfExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createIssueDependencies_4004(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6004 = createLabel(
				edge,
				TrackitVisualIDRegistry
						.getType(IssueDependenciesExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createIssueVersionsAffected_4007(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label6007 = createLabel(
				edge,
				TrackitVisualIDRegistry
						.getType(IssueVersionsAffectedExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createIssueBlocking_4005(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6005 = createLabel(edge,
				TrackitVisualIDRegistry
						.getType(IssueBlockingExternalLabelEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!IssueTrackerEditPart.MODEL_ID.equals(TrackitVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", IssueTrackerEditPart.MODEL_ID); //$NON-NLS-1$
