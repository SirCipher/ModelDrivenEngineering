 ...
 * @generated
 */
public class TrackitDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public TrackitDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof TrackitDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((TrackitDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new TrackitDomainNavigatorItem((EObject) objects[i],
