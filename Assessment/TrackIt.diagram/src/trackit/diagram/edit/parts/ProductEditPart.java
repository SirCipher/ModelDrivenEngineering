...
import trackit.diagram.edit.policies.ProductItemSemanticEditPolicy;
...
public class ProductEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ProductProductVersionCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getProductVersionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ProductProductVersionCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ProductProductVersionCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getProductVersionCompartmentFigure();
			pane.remove(((ProductProductVersionCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ProductProductVersionCompartmentEditPart) {
			return getPrimaryShape().getProductVersionCompartmentFigure();
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == TrackitElementTypes.Version_3001) {
				return getChildBySemanticHint(TrackitVisualIDRegistry
	...
	public class ProductFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fProductVersionCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureProductLabelFigure.setMaximumSize(new Dimension(getMapMode()
					.DPtoLP(10000), getMapMode().DPtoLP(50)));

			this.add(fFigureProductLabelFigure);

			fProductVersionCompartmentFigure = new RectangleFigure();

			fProductVersionCompartmentFigure.setOutline(false);

			this.add(fProductVersionCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getProductVersionCompartmentFigure() {
			return fProductVersionCompartmentFigure;
		}
