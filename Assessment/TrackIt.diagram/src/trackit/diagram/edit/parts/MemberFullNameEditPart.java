 ...
 * @generated
 */
public class MemberFullNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MemberFullNameEditPart(View view) {
		super(view);
	}
			...
			parser = TrackitParserProvider
					.getParser(
							...
							TrackitVisualIDRegistry
									.getType(trackit.diagram.edit.parts.MemberFullNameEditPart.VISUAL_ID));
		}
		return parser;
	}
