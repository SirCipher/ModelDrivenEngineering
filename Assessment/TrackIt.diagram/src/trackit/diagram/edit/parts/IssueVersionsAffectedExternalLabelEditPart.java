 ...
 * @generated
 */
public class IssueVersionsAffectedExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				TrackitVisualIDRegistry
						.getType(trackit.diagram.edit.parts.IssueVersionsAffectedExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public IssueVersionsAffectedExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new IssueVersionsAffectedExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IssueVersionsAffectedExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IssueVersionsAffectedExternalLabelFigure() {
			this.setText("Versions Affected");
		}
