 ...
 * @generated
 */
public class IssueBlockingReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IssueBlockingReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return TrackitBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIssueBlocking_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return TrackitBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIssueBlocking_4005(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getBlocking().remove(getOldTarget());
		getNewSource().getBlocking().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getBlocking().remove(getOldTarget());
		getOldSource().getBlocking().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
