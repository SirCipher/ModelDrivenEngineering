 ...
 * @generated
 */
public class IssueDependenciesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IssueDependenciesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return TrackitBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIssueDependencies_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return TrackitBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistIssueDependencies_4004(getOldSource(), getNewTarget());
	}
